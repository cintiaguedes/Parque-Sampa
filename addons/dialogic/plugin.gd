...
func _init():
	if Engine.editor_hint:
		# Checa para ver se o diretorio existe
...
func _ready():
	if Engine.editor_hint:
		# Forcar abrir a pasta com os dialogos
...
# tentei pesquisar aqui a solução https://github.com/godotengine/godot-proposals/issues/572
